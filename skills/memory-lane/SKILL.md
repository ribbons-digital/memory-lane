...
- The committed OMP `17.1.0` contract verifies all five lifecycle events for both development and release bridge forms, separately passes RPC input absence and genuine real-TTY editor submission, and certifies automatic lifecycle-capture suppression after a completed delegated task.

...
A user-authored Markdown note intentionally placed in Memory Lane's Obsidian import area and marked for import into the Memory Lane JSONL memory store. It is not generated by the mirror and is not imported automatically.
_Avoid_: Mirrored memory file, generated note, whole-vault note

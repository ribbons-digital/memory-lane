...
- Plugin system design started: Phase 9 (Obsidian LLM Wiki / Knowledge Base Integration) will ship as the first opt-in plugin via a lightweight plugin API, keeping core Memory Lane lean.

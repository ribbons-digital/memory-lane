...
3. Before PR, use the global Opus 4.8 review workflow exactly: invoke `claude -p --model=claude-opus-4-8` directly, ask for high-effort thinking in the prompt, and have Opus review the implementation/diff until consensus; do not use subagents for Opus review.

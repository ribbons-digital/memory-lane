...
This guide tests the completed Obsidian work through Phase 3 only. It does not start Phase 4.
...
## 4. Inspect generated mirror file
...
## 5. Mirror sync dry-run writes nothing
...
- Mirror files are reconciled.
- Import folder still exists.

## 7. Create import notes
...
## 11. Generated mirror files are skipped by import

Copy a generated mirror file into imports:
...
## 12. Update an existing memory by id
...
## 13. Duplicate conflict behavior
...
## 14. Soft delete and mirror removal
...
- Sync only removes generated mirror files marked `memory_lane_mirror: true`.
...
- Generated files with `memory_lane_mirror: true` are skipped.

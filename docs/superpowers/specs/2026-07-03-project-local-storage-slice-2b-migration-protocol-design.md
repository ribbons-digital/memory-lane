...
The implementation gate remains closed until this design is reviewed and approved.
No command may silently move, delete, approve, reject, consolidate, or rescope memories before that approval.
...
It records the project scope, source and destination paths, candidate ids, source fingerprints, planned destination records, planned source tombstones, planned embedding actions, hazards, blockers, and the Memory Lane version that produced the plan.
...
- plan generated by a newer incompatible Memory Lane version.
...
This design requires Fable 5 review and explicit user approval before implementation.
